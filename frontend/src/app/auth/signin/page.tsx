...
import { apiLogin, extractToken } from '@/lib/api'
    ...
    <main className="min-h-screen bg-[#0F1117] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-semibold text-[#E8EAF0] mt-2">Sign in</h1>
        </div>
        ...
        <p className="text-center text-sm text-[#6B7280] mt-4">
          No account?{' '}
          <Link href="/auth/signup" className="text-[#4F9CF9] hover:underline">
            Create one
          </Link>
        </p>
      </div>
